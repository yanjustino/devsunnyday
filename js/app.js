	...
	function Talker($scope) {
		...
		[
			...
			},
			{
				...
				"titulo": "Universal Windows Apps",
				"resumo": "Universal Windows Apps são o mais recente modelo de desenvolvimento de aplicações para Windows, Windows Phone, Xbox One, IoT, e os demais dispositivos suportados pela plataforma Microsoft. O grande salto deste novo modelo é o poder de convergência de desenvolvimento que adquirimos ao desenvolver nossas aplicações uma única vez e disponibiliza-la em diferentes frentes. Além do aumento da superfície de disponibilidade de nossos aplicativos, as Universal Windows Apps traem consigo um conceito novo de execução, que une a performance do C++ com a eficiência de desenvolvimento do C#, o então conhecido .NET Native",
